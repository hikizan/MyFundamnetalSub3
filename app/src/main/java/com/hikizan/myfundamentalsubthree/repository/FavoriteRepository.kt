...
class FavoriteRepository(application: Application) {
    ...
    fun detailUserFavorited(login: String) {
        executorService.execute { mFavoriteDao.detailUserFavorited(login) }
    }
    ...
    fun getFavoriteUser(login: String): LiveData<Favorite> = mFavoriteDao.getFavoriteUser(login)

    /*
    fun deleteWithUsername(login: String) {
        executorService.execute { mFavoriteDao.deleteWithUsername(login) }
    }
     */
}